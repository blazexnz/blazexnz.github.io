...
const PHASES = [
  {
    ...
    actions: [
      ...
      "Identify emerging winners/purchases to promote to static ad",
    ...
    metrics: [
      ...
      { key: "cpc", name: "Cost Per Click (CPC)", target: "≤ $1.70", prefix: "$", operator: "lte", threshold: 1.70, higherIsBetter: false, decimal: true },
  ...
  },
  {
    ...
    objectives: [
      ...
      "Run static ads Thu-Sun at $21/day",
