...
const PHASES = [
  ...
  },
  {
    ...
    num: "02",
    name: "Scaling",
    description: "Increase spend on proven winners and scale successful concepts while maintaining strong performance metrics.",
    objectives: [
      "Scale winning ad sets weekly",
      "Maintain ROAS ≥ 2.0 at scale",
