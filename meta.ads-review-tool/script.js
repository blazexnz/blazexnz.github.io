...
const PHASES = [
  ...
  },
  {
    ...
    objectives: [
      ...
      "Keep CPA within profitable targets",
      "Identify concepts with long-term scaling potention",
      "Monitor creative fatigue and audience saturation",
    ],
    actions: [
      "Increase budgets gradually on stable performers",
      "Monitor ROAS and CPA daily",
      "Launch iterations of winning concepts weekly",
      "Refresh ctratives when CTR declines",
      "Watch frequency for fatigue signals",
      "Continue testing new designs alongside scaling",
    ],
    metrics: [
