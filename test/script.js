...
document.addEventListener("click", function (event) {
    if (event.target !== document.getElementById("numberInput")) {
        ...
        document.getElementById("numberInput").value = currentIndex.toString().padStart(2, "0");
        displayResult(currentIndex);
    }
});
