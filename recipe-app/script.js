  ...
  },
{
  ...
  checklist: {
    ...
    content: `
      ...
      <ul>
        <li><input type="checkbox">Feed the starter for 4 hrs</li>
        <li><input type="checkbox">Combine & rest for 30 mins</li>
        <li><input type="checkbox">Stretch & fold #1 then rest for 1 hr</li>
        <li><input type="checkbox">Stretch & fold #2 then rest for 4 hrs</li>
        <li><input type="checkbox">Shape then rest for 1.5 hrs</li>
      </ul>
      <p><strong>Ready to bake</strong></p>
      <ul>
        <li><input type="checkbox">30 mins before baking, preheat oven 260°C (with Dutch oven inside)</li>
        <li><input type="checkbox">Brush off excess flour</li>
        <li><input type="checkbox">Score the dough</li>
        <li><input type="checkbox">Bake 20 mins - lid on</li>
  ...
  notes: {
    ...
    content: `
      <ul>
        <li>11 hrs ready to bake, 12.5 hrs ready to eat (if starter needs feeding today)</li>
        <li>7 hrs ready to bake, 8.5 hrs ready to eat (if starter already active from last night)</li>
      </ul>
    `
  },
  day0: {
    ...
    content: `
      <ul>
        <li>Out of the fridge: Feed starter for 4 hrs</li>
        <li>If fed last night, then ready to use</li>
      </ul>
    `
  },
  day1: {
    ...
    content: `
      <ol>
        ...
        <li>Cover & rest for 30 mins</li>
        <li>Stretch & fold #1 - twice around the bowl</li>
        <li>Cover & rest for 1 hour</li>
        <li>Stretch & fold #2 - twice around the bowl</li>
        <li>Cover & rest for 4 hrs</li>
        <li>Dust basket with rice flour</li>
        <li>Shape dough: form rectangle, place seam side up in basket</li>
        <li>Cover & rest for 1.5 hrs (or overnight in fridge)</li>
      </ol>
    `
  },
  day2: {
    ...
    content: `
      <ol>
        ...
        <li>Brush off excess flour</li>
        <li>Score the dough</li>
        <li>Transfer to Dutch oven, lifting with baking paper</li>
        <li>Bake:
          <ul>
            <li>20 mins with lid on</li>
  ...
  tags: ["bread", "sourdough", "dough handling"]
},
{
  ...
  method: {
    ...
    content: `
      <ol>
        ...
        <li>Dust basket with rice flour</li>
        <li>Shape: scoop out of bowl, form a rectangle, place in basket seam side up, dust dough with rice flour</li>
